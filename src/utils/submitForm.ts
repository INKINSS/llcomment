...
//reemplazar espacios en blanco por guiones en el campo de titulo
const titleAlter = (title: string) => {
...
export const submitForm = async (formData) => {
  try {
    ...
    const formRef = ref(database, 'posts/' + titleAlter(parsedData.title));
